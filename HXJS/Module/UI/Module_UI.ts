...
@ccclass
export default class Module_UI extends cc.Component 
{
    public static Instance:Module_UI;
    ...
    private rootUI: cc.Node = null;
    @property({type:cc.Node})
    private rootUI4Scene: cc.Node = null;
    @property({type:cc.Node})
    private uiLoading: cc.Node = null;
    @property({type:cc.Node})
    private uwLoading: cc.Node = null;
    @property({type:cc.Node})
    private waiting: cc.Node = null;

    private panels:any[] = [];
    private dlgs:Map<string, cc.Node> = new Map<string, cc.Node>();
    private asyncPanels:Map<string, number> = new Map<string, number>();
    
    private assetGroupLoader:AssetGroupLoader = null;

    // LIFE-CYCLE CALLBACKS: ////////////////////////////////////////
    onLoad () {
        if(!Module_UI.Instance)
            Module_UI.Instance = this;
        ...
        hxjs.module.ui.history.Init(this);
        this.HideWaitingUI();
    }
    /////////////////////////////////////////////////////////////////
     ...
     */
    LoadPanel(prefabName:string, callback?:Function, con?:cc.Node) {
        if (hxdt.setting_ui.ScreenPanels.indexOf(prefabName) != -1) {
            this.LoadPanelStack(prefabName);
            return;
        }
    ...
    LoadPanel4SceneDefaultGroup (prefabName:string, callback?: Function) {
    ...
    LoadSceneSub (prefabName:string, callback?:Function) {
        //Old //LoadPrefab4SceneDefaultGroup
        hxjs.module.asset.LoadPrefab4SceneUI(prefabName, function (prefab) {
            this.panels.push(prefab);
    ...
    ShowObjAnim (uiCom:any, cb?:Function) {
        // 如果有UIAnim脚本，则可以定制延时等，否则
        let animCtrl:any = uiCom.getComponent('UIAnim');
        if (animCtrl != null) {
            animCtrl.Show(cb);
        }
        else {
    ...
    LoadPanelStack(fnPanelName:string, cb?:Function) {
        hxjs.module.ui.hub.ShowLoadingUI();
