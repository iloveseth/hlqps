...
cc.Class({
    ...
    onLoad: function () {
        this._urls = [
            ...
            cc.url.raw("resources/art/prefab/UI_LevelDifficulty_Style1.prefab"),
    ...
    _progressCallback: function (completedCount, totalCount, res) {
        ...
        cc.log('MMMMMMMMMMMMMMMMMMMMMM _progressCallback completedCount: ' + completedCount);
        cc.log('MMMMMMMMMMMMMMMMMMMMMM _progressCallback totalCount: ' + totalCount);
        cc.log('MMMMMMMMMMMMMMMMMMMMMM _progressCallback res: ' + res);
    },

    _completeCallback: function (error, res) {
        cc.log('MMMMMMMMMMMMMMMMMMMMMM _completeCallback res: ' + res);

        let p = 'art/prefab/' + 'UI_LevelDifficulty_Style1';
        
                cc.loader.loadRes(p, function (err, prefab) {
                    var newNode = cc.instantiate(prefab);
                    // if(!isUI)
                        // this.rootUW.addChild(newNode);
